#!/usr/bin/env python3
"""
Interface en ligne de commande pour la version naïve
du graphe de De Bruijn coloré.
"""
import argparse
...
def main():
    parser = argparse.ArgumentParser(
        description="Naive colored De Bruijn graph indexer"
    )
    sub = parser.add_subparsers(dest="cmd")

    # BUILD
    b = sub.add_parser("build", help="Construire l'index naïf")
    ...
    # QUERY
    q = sub.add_parser("query", help="Interroger l'index naïf")
